...
latex_documents = [
  ('index', 'textract.tex', 'textract Documentation',
   'Dean Malmgren', 'manual'),
]
...
man_pages = [
    ('index', 'textract', 'textract Documentation',
     ['Dean Malmgren'], 1)
]
...
texinfo_documents = [
  ('index', 'textract', 'textract Documentation',
   'Dean Malmgren', 'textract', 'One line description of project.',
   'Miscellaneous'),
]
